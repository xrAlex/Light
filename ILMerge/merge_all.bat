...
rem #run merge cmd
@echo Merging: '""%ILMergeSolution%" /wildcards /targetplatform:%net% /out:"%result%" %target_path% "%target_dir%*.dll"'
"%ILMergeSolution%" /wildcards /targetplatform:%net% /out:"%result%" %target_path% "%target_dir%*.dll"
